...
{
    internal class FileToFileChildFinder
    {
        ...
        public FileToFileChildFinder(List<FileAssociationExtended> associationsExtended, Dictionary<long, FileIterationExtended> fileIterExtended)
        {
